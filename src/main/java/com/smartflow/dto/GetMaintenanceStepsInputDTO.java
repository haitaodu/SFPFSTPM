...
public class GetMaintenanceStepsInputDTO {
	...
	public GetMaintenanceStepsInputDTO() {
		
	}

	public GetMaintenanceStepsInputDTO(Integer workItemId, String itemName, String position, String materialNumber,
